...
Ported from an original Perl version from 2014 in the DevOps Perl tools repo: https://github.com/nholuongut/devops-perl-tools
...
const text = "https://www.linkedin.conhom/in/nholuong"
