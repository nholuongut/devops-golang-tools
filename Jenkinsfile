...
//
// https://github.com/https://www.linkedin.conhom/in/nholuongut/Templates/blob/master/Jenkinsfile
...
pipeline {
  ...
  stages {
    stage ('Checkout') {
      steps {
        checkout([$class: 'GitSCM', branches: [[name: '*/master']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: '', url: 'https://github.com/nholuongut/devops-golang-tools']]])
      }
    }
