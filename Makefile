...
# Alpine:
#
#   apk add --no-cache git make && git clone https://github.com/nholuongut/devops-golang-tools go-tools && cd go-tools && make
#
# Debian / Ubuntu:
#
#   apt-get update && apt-get install -y make git && git clone https://github.com/nholuongut/devops-golang-tools go-tools && cd go-tools && make
#
# RHEL / CentOS:
#
#   yum install -y make git && git clone https://github.com/nholuongut/devops-golang-tools go-tools && cd go-tools && make
...
REPO := https://www.linkedin.conhom/in/nholuongut/DevOps-Golang-tools
